...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m13(episodes) =>
      "${Intl.plural(episodes, one: '1 непрослушаный выпуск', other: '${episodes} непрослушаных выпусков')}";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
        ...
        'consent_message': MessageLookupByLibrary.simpleMessage(
            'Эта ссылка на финансирование приведёт вас на внешний сайт, где вы сможете напрямую поддерживать шоу. Ссылки предоставляются авторами подкаста и не контролируются Энитаймом.'),
        ...
        'delete_episode_confirmation':
            MessageLookupByLibrary.simpleMessage('Вы уверены, что хотите удалить этот выпуск?'),
        ...
        'episode_filter_no_episodes_title_description':
            MessageLookupByLibrary.simpleMessage('В этом подкасте нет выпусков по вашим критериям поиска и фильтру'),
        ...
        'error_no_connection': MessageLookupByLibrary.simpleMessage(
            'Не могу воспроизвести эпизод. Проверьте соединение и попробуйте ещё раз.'),
        'error_playback_fail': MessageLookupByLibrary.simpleMessage(
            'При воспроизведении произошла неожиданная ошибка. Проверьте соединение и попробуйте еще раз.'),
        ...
        'mark_episodes_not_played_label':
            MessageLookupByLibrary.simpleMessage('Отметить все выпуски как ещё непрослушанные'),
        ...
        'no_podcast_details_message': MessageLookupByLibrary.simpleMessage(
            'Не удалось скачать выпуски подкаста. Пожалуйста, проверьте соединение.'),
        ...
        'no_subscriptions_message': MessageLookupByLibrary.simpleMessage(
            'Нажмите кнопку Обзор ниже или используйте панель поиска выше, чтобы найти свой первый подкаст'),
        ...
        'podcast_context_play_next_episode_label':
            MessageLookupByLibrary.simpleMessage('Играть следующий непрослушаный выпуск'),
        'podcast_context_queue_latest_episode_label':
            MessageLookupByLibrary.simpleMessage('Последний выпуск в очередь'),
        'podcast_context_queue_next_episode_label':
            MessageLookupByLibrary.simpleMessage('Следующий непрослушаный выпуск в очередь'),
        ...
        'semantic_playing_options_collapse_label':
            MessageLookupByLibrary.simpleMessage('Закрыть опции проигрывания с прокруткой'),
        'semantic_playing_options_expand_label':
            MessageLookupByLibrary.simpleMessage('Открыть опции проигрывания с прокруткой'),
        ...
        'semantics_episode_tile_collapsed': MessageLookupByLibrary.simpleMessage(
            'Пункт списка выпусков. Отображает изображение, сводку и основные элементы управления.'),
        'semantics_episode_tile_collapsed_hint':
            MessageLookupByLibrary.simpleMessage('развернуть и показать больше подробностей и дополнительных опций'),
        'semantics_episode_tile_expanded': MessageLookupByLibrary.simpleMessage(
            'Пункт списка выпусков. Отображает описание, основные и дополнительные элементы управления.'),
        'semantics_episode_tile_expanded_hint': MessageLookupByLibrary.simpleMessage(
            'свернуть и показать только сводку, скачивание и управление воспроизведением'),
        ...
        'semantics_mark_episode_unplayed':
            MessageLookupByLibrary.simpleMessage('Отметить выпуск как ещё непрослушанный'),
        'semantics_mini_player_header': MessageLookupByLibrary.simpleMessage(
            'Мини проигрыватель. Проведите в право чтобы начать или приостановить прослушивание. Активируйте чтобы открыть главное окно проигрывателя'),
        ...
        'semantics_podcast_details_header':
            MessageLookupByLibrary.simpleMessage('Подробности подкаста и страница выпусков'),
        'semantics_remove_from_queue': MessageLookupByLibrary.simpleMessage('Удалить выпуск из очереди'),
        'settings_auto_open_now_playing':
            MessageLookupByLibrary.simpleMessage('Полноэкранный режим проигрывателя при начале выпуска'),
        ...
        'settings_auto_update_episodes_10min':
            MessageLookupByLibrary.simpleMessage('10 минут после последнего обновления'),
        ...
        'settings_background_refresh_mobile_data_option':
            MessageLookupByLibrary.simpleMessage('Обновлять когда на мобильной сети'),
        'settings_background_refresh_mobile_data_option_subtitle':
            MessageLookupByLibrary.simpleMessage('Позволить обновлять библиотеку когда используются мобильные данные'),
        ...
        'settings_background_refresh_option_subtitle':
            MessageLookupByLibrary.simpleMessage('Обновлять выпуски когда экран отключен. Это подразрядит батарею.'),
        ...
        'settings_continuous_play_subtitle': MessageLookupByLibrary.simpleMessage(
            'Автоматически воспроизводить следующий эпизод в подкасте, если очередь пуста'),
        'settings_data_divider_label': MessageLookupByLibrary.simpleMessage('ДАННЫЕ'),
        'settings_delete_played_label':
            MessageLookupByLibrary.simpleMessage('Удалять скачанные выпуски после прослушивания'),
        ...
        'settings_download_switch_card': MessageLookupByLibrary.simpleMessage(
            'Новые скачивания будут сохраняться на SD-карте. Уже существующие так и останутся на внутреннем хранилище.'),
        'settings_download_switch_internal': MessageLookupByLibrary.simpleMessage(
            'Новые скачивания будут сохраняться на внутреннем хранилище. Уже существующие так и останутся на SD-ка��те.'),
        ...
        'settings_mark_deleted_played_label':
            MessageLookupByLibrary.simpleMessage('Отметить удалённые выпуски как прослушанные'),
        ...
        'settings_refresh_notification_option_subtitle':
            MessageLookupByLibrary.simpleMessage('Отображать значок уведомления когда обновляются выпуски'),
        ...
        'stop_download_confirmation':
            MessageLookupByLibrary.simpleMessage('Вы уверены, что хотите остановить скачивание и удалить выпуск?'),
        ...
        'unsubscribe_message': MessageLookupByLibrary.simpleMessage(
            'При отмене ��одписки будут удалены все загруженные эпизоды этого подкаста.'),
