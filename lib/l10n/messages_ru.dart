...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
        ...
        'settings_auto_update_episodes_12hour':
            MessageLookupByLibrary.simpleMessage('12 часов с последнего обновления'),
        ...
        'settings_auto_update_episodes_30min':
            MessageLookupByLibrary.simpleMessage('30 минут после последнего обновления'),
        'settings_auto_update_episodes_3hour':
            MessageLookupByLibrary.simpleMessage('3 часа с момента последнего обновления'),
        'settings_auto_update_episodes_6hour':
            MessageLookupByLibrary.simpleMessage('6 часов с момента последнего обновления'),
        'settings_auto_update_episodes_always': MessageLookupByLibrary.simpleMessage('Всегда'),
        'settings_auto_update_episodes_heading':
            MessageLookupByLibrary.simpleMessage('Обновить выпуски на странице сведений после'),
