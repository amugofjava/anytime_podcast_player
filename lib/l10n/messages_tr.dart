...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m13(episodes) =>
      "${Intl.plural(episodes, one: '1 oynatılmamış bölüm', other: '${episodes} oynatılmamış bölüm')}";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
        ...
        'alert_sync_title_body':
            MessageLookupByLibrary.simpleMessage('Podcast kitaplığınızı istediğiniz zaman güncelleyebilirsiniz'),
        ...
        'consent_message': MessageLookupByLibrary.simpleMessage(
            'Bu fon bağlantısı sizi, programı doğrudan destekleyebileceğiniz harici bir siteye yönlendirecektir. Bağlantılar podcast yazarları tarafından sağlanmaktadır ve Anytime tarafından kontrol edilmemektedir.'),
        ...
        'delete_episode_confirmation':
            MessageLookupByLibrary.simpleMessage('Bu bölümü silmek istediğinizden emin misiniz?'),
        ...
        'episode_filter_no_episodes_title_description':
            MessageLookupByLibrary.simpleMessage('Bu podcastte aradığınız kriter ve filtreye uyan bölüm bulunmuyor'),
        ...
        'error_no_connection': MessageLookupByLibrary.simpleMessage(
            'Bölüm oynatılamıyor. Lütfen bağlantınızı kontrol edin ve tekrar deneyin.'),
        'error_playback_fail': MessageLookupByLibrary.simpleMessage(
            'Oynatma sırasında beklenmedik bir hata oluştu. Lütfen bağlantınızı kontrol edin ve tekrar deneyin.'),
        ...
        'mark_episodes_not_played_label':
            MessageLookupByLibrary.simpleMessage('Tüm bölümleri oynatılmamış olarak işaretle'),
        ...
        'no_podcast_details_message':
            MessageLookupByLibrary.simpleMessage('Podcast bölümleri yüklenemedi. Lütfen bağlantınızı kontrol edin.'),
        ...
        'no_subscriptions_message': MessageLookupByLibrary.simpleMessage(
            'Aşağıdaki Keşfet butonunu kullanarak veya yukarıdaki arama çubuğu ile ilk podcastini bulabilirsin'),
        'no_transcript_available_label':
            MessageLookupByLibrary.simpleMessage('Bu podcast için transkript mevcut değil'),
        ...
        'podcast_context_play_next_episode_label':
            MessageLookupByLibrary.simpleMessage('Bir sonraki oynatılmamış bölümü oynat'),
        ...
        'podcast_context_queue_next_episode_label':
            MessageLookupByLibrary.simpleMessage('Sıradaki oynatılmamış bölümü sıraya ekle'),
        ...
        'semantic_playing_options_collapse_label':
            MessageLookupByLibrary.simpleMessage('Oynatma seçenekleri kaydırıcısını kapat'),
        'semantic_playing_options_expand_label':
            MessageLookupByLibrary.simpleMessage('Oynatma seçenekleri kaydırıcısını aç'),
        'semantic_podcast_artwork_label':
            MessageLookupByLibrary.simpleMessage('Ana oynatıcıda podcast görüntüsünün etrafına yerleştirildi'),
        ...
        'semantics_episode_tile_collapsed':
            MessageLookupByLibrary.simpleMessage('Bölüm listesi öğesi. Resim, özet ve ana kontroller gösteriliyor.'),
        'semantics_episode_tile_collapsed_hint':
            MessageLookupByLibrary.simpleMessage('genişlet ve daha fazla ayrıntı ve ek seçenekleri göster'),
        'semantics_episode_tile_expanded': MessageLookupByLibrary.simpleMessage(
            'Bölüm listesi öğesi. Açıklama, ana kontroller ve ek kontroller gösteriliyor.'),
        'semantics_episode_tile_expanded_hint':
            MessageLookupByLibrary.simpleMessage('özeti göster ve daralt, indir ve oynat kontrolü'),
        ...
        'semantics_mini_player_header': MessageLookupByLibrary.simpleMessage(
            'Mini oynatıcı. Oynat/duraklat düğmesine sağa kaydırın. Ana oynatıcı penceresini açmak için etkinleştirin'),
        'semantics_play_pause_toggle': MessageLookupByLibrary.simpleMessage('Oynat/duraklat düğmesi'),
        'semantics_podcast_details_header':
            MessageLookupByLibrary.simpleMessage('Podcast ayrıntıları ve bölüm sayfası'),
        ...
        'settings_background_refresh_mobile_data_option':
            MessageLookupByLibrary.simpleMessage('Mobil veri kullanırken yenile'),
        'settings_background_refresh_mobile_data_option_subtitle':
            MessageLookupByLibrary.simpleMessage('Mobil veri kullanırken kütüphanenin yenilenmesine izin ver'),
        ...
        'settings_background_refresh_option_subtitle':
            MessageLookupByLibrary.simpleMessage('Ekran kapalıyken bölümleri yenile. Bu pil kullanımını artıracaktır.'),
        'settings_continuous_play_option': MessageLookupByLibrary.simpleMessage('Sürekli oynatma'),
        'settings_continuous_play_subtitle':
            MessageLookupByLibrary.simpleMessage('Kuyruk boşsa podcastteki bir sonraki bölümü otomatik olarak oynat'),
        'settings_data_divider_label': MessageLookupByLibrary.simpleMessage('VERİ'),
        'settings_delete_played_label':
            MessageLookupByLibrary.simpleMessage('İzlendikten sonra indirilen bölümleri sil'),
        ...
        'settings_download_switch_card': MessageLookupByLibrary.simpleMessage(
            'Yeni indirmeler SD karta kaydedilecektir. Mevcut indirmeler dahili depolama alanında kalacaktır.'),
        'settings_download_switch_internal': MessageLookupByLibrary.simpleMessage(
            'Yeni indirmeler dahili depolama alanına kaydedilecektir. Mevcut indirmeler SD kartta kalacaktır.'),
        ...
        'settings_mark_deleted_played_label':
            MessageLookupByLibrary.simpleMessage('Silinen bölümleri izlendi olarak işaretle'),
        ...
        'settings_refresh_notification_option_subtitle':
            MessageLookupByLibrary.simpleMessage('Bölümler yenilenirken bildirim simgesi göster'),
        ...
        'stop_download_confirmation':
            MessageLookupByLibrary.simpleMessage('Bu indirmeyi durdurup bölümü silmek istediğinizden emin misiniz?'),
        ...
        'unsubscribe_message':
            MessageLookupByLibrary.simpleMessage('Takibi bırakmak, bu podcastin indirilen tüm bölümlerini siler.'),
