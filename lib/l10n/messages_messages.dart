...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
        ...
        'active_downloads_empty_message':
            MessageLookupByLibrary.simpleMessage('No active downloads or transcoding tasks'),
        ...
        'batch_action_delete': MessageLookupByLibrary.simpleMessage('Delete'),
        'batch_action_mark_played': MessageLookupByLibrary.simpleMessage('Mark Played'),
        'batch_action_mark_unplayed': MessageLookupByLibrary.simpleMessage('Mark Unplayed'),
        'batch_action_queue': MessageLookupByLibrary.simpleMessage('Add to Queue'),
        'batch_add_to_queue_success': MessageLookupByLibrary.simpleMessage('Added selected episodes to queue'),
        'batch_delete_dialog_message':
            MessageLookupByLibrary.simpleMessage('Are you sure you want to delete the selected downloaded episodes?'),
        'batch_delete_dialog_title': MessageLookupByLibrary.simpleMessage('Delete Episodes'),
        ...
        'download_action_cancel': MessageLookupByLibrary.simpleMessage('Cancel'),
        'download_action_pause': MessageLookupByLibrary.simpleMessage('Pause'),
        'download_action_resume': MessageLookupByLibrary.simpleMessage('Resume'),
        'download_action_retry': MessageLookupByLibrary.simpleMessage('Retry'),
        'download_episode_button_label': MessageLookupByLibrary.simpleMessage('Download episode'),
        'download_status_converting': MessageLookupByLibrary.simpleMessage('Converting'),
        'download_status_downloading': MessageLookupByLibrary.simpleMessage('Downloading'),
        'download_status_failed': MessageLookupByLibrary.simpleMessage('Failed'),
        'download_status_paused': MessageLookupByLibrary.simpleMessage('Paused'),
        'download_status_queued': MessageLookupByLibrary.simpleMessage('Queued'),
        'downloads': MessageLookupByLibrary.simpleMessage('Downloads'),
        'downloads_tab_active': MessageLookupByLibrary.simpleMessage('Downloading'),
        'downloads_tab_downloaded': MessageLookupByLibrary.simpleMessage('Downloaded'),
        ...
        'multi_select_deselect_all': MessageLookupByLibrary.simpleMessage('Deselect All'),
        'multi_select_exit': MessageLookupByLibrary.simpleMessage('Exit'),
        'multi_select_select_all': MessageLookupByLibrary.simpleMessage('Select All'),
        ...
        'podcast_context_queue_latest_episode_label':
            MessageLookupByLibrary.simpleMessage('Add most recent episode to the queue'),
        ...
        'semantics_episode_tile_collapsed':
            MessageLookupByLibrary.simpleMessage('Episode list item. Showing image, summary and main controls.'),
        'semantics_episode_tile_collapsed_hint':
            MessageLookupByLibrary.simpleMessage('expand and show more details and additional options'),
        ...
        'semantics_episode_tile_expanded_hint':
            MessageLookupByLibrary.simpleMessage('collapse and show summary, download and play control'),
        ...
        'settings_auto_download_episodes_subtitle':
            MessageLookupByLibrary.simpleMessage('Automatically download latest episodes when detected'),
        'settings_auto_download_no_subscriptions':
            MessageLookupByLibrary.simpleMessage('No subscribed podcasts found. Please subscribe to podcasts first.'),
        'settings_auto_download_podcasts_label':
            MessageLookupByLibrary.simpleMessage('Choose podcasts to auto-download'),
        ...
        'settings_background_refresh_mobile_data_option':
            MessageLookupByLibrary.simpleMessage('Refresh when on mobile data'),
        'settings_background_refresh_mobile_data_option_subtitle':
            MessageLookupByLibrary.simpleMessage('Allow the library to be refreshed when on mobile data'),
        ...
        'settings_convert_to_mp3_subtitle':
            MessageLookupByLibrary.simpleMessage('Automatically convert downloaded episodes to MP3'),
        'settings_custom_download_path_default': MessageLookupByLibrary.simpleMessage('Default'),
        'settings_custom_download_path_label': MessageLookupByLibrary.simpleMessage('Custom download folder'),
        'settings_custom_download_path_permission_message': MessageLookupByLibrary.simpleMessage(
            'To save downloads to a custom folder outside the app, Anytime requires All Files Access permission.'),
        'settings_custom_download_path_permission_title':
            MessageLookupByLibrary.simpleMessage('Storage Permission Required'),
        'settings_custom_download_path_reset': MessageLookupByLibrary.simpleMessage('Reset to default'),
        ...
        'settings_language_chinese': MessageLookupByLibrary.simpleMessage('Chinese'),
        'settings_language_english': MessageLookupByLibrary.simpleMessage('English'),
        'settings_language_label': MessageLookupByLibrary.simpleMessage('Language'),
        'settings_language_system': MessageLookupByLibrary.simpleMessage('Follow system'),
        ...
        'settings_refresh_notification_option_subtitle':
            MessageLookupByLibrary.simpleMessage('Show a notification icon when episodes are being refreshed.'),
