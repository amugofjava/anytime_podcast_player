...
class ChapterSelectorWidget extends StatefulWidget {
  ...
  @override
  _ChapterSelectorWidgetState createState() => _ChapterSelectorWidgetState();
}

class _ChapterSelectorWidgetState extends State<ChapterSelectorWidget> {
  @override
  void initState() {
    super.initState();
