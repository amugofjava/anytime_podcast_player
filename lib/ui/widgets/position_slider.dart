...
/// This is a copy of the Slider class from the Flutter SDK. This is necessary because
/// the hardcoded label animation causes lag when dragging the slider during playback.
/// This version sets the animation to zero and greatly improves performance. This is
/// linked to issue: https://github.com/flutter/flutter/issues/51715#issuecomment-3660789516
...
enum PositionSliderInteraction {
...
class _PositionSliderState extends State<PositionSlider> with TickerProviderStateMixin {
...
class _SliderRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  final ValueChanged<double>? onChangeEnd;
  final SemanticFormatterCallback? semanticFormatterCallback;
  final _PositionSliderState state;
  final bool hasFocus;
  final bool hovering;
  final SliderInteraction allowedInteraction;
...
class _RenderSlider extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  _RenderSlider({
    ...
    required this.onChangeStart,
    required this.onChangeEnd,
    required _PositionSliderState state,
  ...
  static const Duration _positionAnimationDuration = Duration(milliseconds: 0);
...
class _RenderValueIndicator extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  _RenderValueIndicator({required _PositionSliderState state}) : _state = state {
    _valueIndicatorAnimation = CurvedAnimation(
      parent: _state.valueIndicatorController,
      curve: Curves.fastOutSlowIn,
    );
